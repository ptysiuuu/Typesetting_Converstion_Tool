...
#include "include/parsers/gfm_parser.h"   
#include "include/writers/latex_writer.h" 
#include "include/writers/typst_writer.h" 
#include <stdexcept>

std::string convert_markdown(const std::string& source_text, const std::string& target_format) {
    GFMParser parser;   //  TODO: TO BE CHANGED IN CASE THERE IS A DIFFERENT PARSER NAME 
    ...
    if (target_format == "latex") {
        ...
        throw std::invalid_argument("Unsupported target format: " + target_format);
    }
}